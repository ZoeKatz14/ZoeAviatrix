...
func refuel(myPlane : Aviatrix) {
    ...
    print("Refueling...")
    print("⛽ Here in \(plane.location), jet fuel costs \(refuelData).")
    print("⛽ You refueled \(plane.amountFilled) gallons totaling $\(plane.amountFilled*refuelData) dollars.")
}
...
var plane = Aviatrix(authorName : "Zoe")
...
print(" ")
print("Thanks for flying with Klossy airlines!")
